...
@required
- (void)paginator:(id)paginator didReceiveResults:(NSArray *)results withResponseData:(id)responseData;
@optional
...
- (void)receivedResults:(NSArray *)results total:(NSInteger)total withResponseData:(id)responseData;
- (void)failed;
