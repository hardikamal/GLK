...
- (void)setUpForNavigationBar {
    ...
    [CommonFunctions setNavigationBarBackgroundWithImageName : IMG(@"navigationBarBackground") fromViewController : self];
    self.navigationController.navigationBar.titleTextAttributes = @{ NSForegroundColorAttributeName: [UIColor blackColor] };
    
    self.title = @"Contacts";
    
    [CommonFunctions addLeftNavigationBarEditButton:self withImageName:@"arrowBack" WithTitle:@"Back" WithNegativeSpacerValue:0];
    [CommonFunctions addRightNavigationBarButton:self withImageName:@"transparent120x48" WithTitle:@"Done" WithNegativeSpacerValue:0];
}
