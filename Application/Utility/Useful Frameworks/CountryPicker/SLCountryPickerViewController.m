...
- (void)createSearchBar {
    if (self.tableView && !self.tableView.tableHeaderView) {
        UISearchBar *theSearchBar = [[UISearchBar alloc] initWithFrame:CGRectMake(0, 0, 320, 44)];
...
- (void)setUpForNavigationBar {
    ...
    [CommonFunctions setNavigationTitle : @"Select Country" ForNavigationItem :[self navigationItem]];
    [CommonFunctions addLeftNavigationBarButton:self withImageName:@"transparent120x48" WithTitle:@"Back" WithNegativeSpacerValue:0];
}
