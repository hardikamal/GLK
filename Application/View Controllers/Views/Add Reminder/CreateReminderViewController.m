...
@synthesize transaction, pickerViewDays, pickerViewHours, scrollViewSubview;
...
- (void)receivedNotification:(NSNotification *)notification {
    ...
    if ([[info objectForKey:@"tag"] intValue] == 1) {
        ...
        else { [self.btnProfileName setTitle:[info objectForKey:@"object"] forState:UIControlStateNormal];
