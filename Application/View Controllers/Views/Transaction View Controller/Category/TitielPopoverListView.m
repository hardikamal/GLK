...
@interface TitielPopoverListView ()
...
@implementation TitielPopoverListView
...
- (void)defalutInit
{
    ...
    [_titleView setFont:[UIFont fontWithName:Ebrima_Bold size:16.0f]];
...
{
    NSString * noticationName =@"TielPopoverList";
     NSMutableDictionary *dic= [_listArray objectAtIndex:[indexPath row]];
    [dic setObject:_categeryOrsubcategery forKey:@"categeryOrsubcategery"];
    [self dismiss];
    [[NSNotificationCenter defaultCenter] postNotificationName:noticationName object:nil userInfo:[_listArray objectAtIndex:[indexPath row]]];
}
